...
public class GetDeviceInfo extends AsyncTask<Void, Void, String> {
    ...
    public GetDeviceInfo(String DeviceID) {
        ...
        try {
            ...
            long time = System.currentTimeMillis();
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    String urlstr="http://rinotrack.unistrong.com/v1.0/webapi/device/getDeviceInfo?sign=" +     responseDataArray.data + "&accessKeyId=75a7759acd1c4a228f188846b3dade5a&timestamp=" + time;

                  //  String urlstr="http://rinotrack.unistrong.com/v1.0/webapi/site/getSiteByOrgid?sign=" + responseDataArray.data + "&accessKeyId=75a7759acd1c4a228f188846b3dade5a&timestamp=" + time;
